...
<body>
 <div class="container">
 <div class="älert alert-success" role="alert" id="successAlert">
 				...
 				<c:when test="${not empty items}">
 					<c:forEach var="s" items="${items}">
 						<tr>
 							...
 							<td>
								<div class="d-flex">
									<a href="editSkill.jsp?id=${s.id}" class="btn btn-primary btn-sm" style="margin-right: 10px;" role="button"><i class="fas fa-edit">
										</i>
											Éditer</a>
